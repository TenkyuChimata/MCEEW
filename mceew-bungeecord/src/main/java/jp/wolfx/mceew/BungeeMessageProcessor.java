...
/**
 * BungeeCord-side boundary over the shared router, freshness rules, and earthquake cache.
 * The class lives beside the package-private cache so the core cache does not need a new API.
 */
public final class BungeeMessageProcessor {
    ...
    BungeeMessageProcessor(
        ...
        this.freshnessEvaluator = Objects.requireNonNull(
                freshnessEvaluator, "freshnessEvaluator");
    }
